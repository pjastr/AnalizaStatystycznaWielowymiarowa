...
Jeśli prawodpobieństwo jest większe niż poziom ufności (domyślnie $\alpha=0,05$) to odrzucamy $H_0$ na rzecz $H_1$. W przeciwnym wypadku nie mamy podstaw do odrzucenia $H_0$.

W rozważanym przykładzie jedynie w przypadku zmiennej `newspaper` odrzucamy $H_0$.
